...
public class Sudoku {    
    ...
    public Sudoku() {
        ...
        this.colEmpty = new boolean[9][10];
        this.rowEmpty = new boolean[9][10];
    }
    ...
    public void placeVal(int val, int row, int col) {
        ...
        this.colEmpty [col][val]= true;
        this.rowEmpty [row][val] = true;
    }
    ...
    public void removeVal(int val, int row, int col) {
        ...
        /*** UPDATE YOUR ADDITIONAL FIELDS HERE. ***/
        this.colEmpty[col][val] = false;
        this.rowEmpty [row][val]= false;
    }  
    ...
    private boolean isSafe(int row, int col, int val) {
        return (this.colEmpty[col][val] == false && 
                this.rowEmpty[row][val] == false && 
                this.subgridHasVal[row/3][col/3][val] ==  false); 
    } 
